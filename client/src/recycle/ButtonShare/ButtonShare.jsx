...
import style from "./ButtonShare.module.css";

export default function ButtonShare({description}) {
  ...
  return (
    ...
    {show && <div  className={style.shareIconCollections}>
    {/* Facebook */}
    ...
    {/* Twitter */}
    <a href={`https://twitter.com/intent/tweet?url=${url}&text=${encodeURI(description)}`} target="_blank" rel="noreferrer">
    ...
    {/* Twitter */}
    {/* Pintrest */}
    <a href={`https://pinterest.com/pin/create/button/?url=${url}&media=&description=${encodeURI(description)}`} target="_blank" rel="noreferrer">
